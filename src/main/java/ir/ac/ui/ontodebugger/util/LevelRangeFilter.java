...
/**
 * adopted from https://github.com/AugustusKling/yield/blob/master/src/main/java/yield/log4j2/LevelRangeFilter.java
 */
...
public class LevelRangeFilter extends AbstractFilter {
     ...
     * @param onMatch    Action to take on a match.
     * @param onMismatch Action to take on a mismatch.
